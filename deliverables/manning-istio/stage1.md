# Deploying a Microservices-Based Application on Istio

> The deliverable for this milestone is the output of the “istioctl verify-install” command which verifies that Istio is installed correctly and all the checks are passing. This is an important post-install install to ensure your Istio service mesh is functioning properly.

`Deliverables and works`

```bash
$  istioctl version
client version: 1.9.8
control plane version: 1.9.8
data plane version: 1.9.8 (13 proxies)
